...
import org.lt.restful.common.spring.AntPathMatcher;
...
//        return "Service path not found";
    ...
    public String[] getSeparators() {
        return new String[]{SymbolConstant.SLASH, SymbolConstant.INTERROGATION_MARK};
    }
...
//        pattern = ToolUtils.removeRedundancyMarkup(pattern);
